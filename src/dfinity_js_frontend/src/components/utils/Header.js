...
import AddAsset from "../assetManager/AddAsset";
import AddUser from "../userManager/AddUser";
import { Link } from "react-router-dom";

const Header = ({ saveAsset, saveUser }) => {
    ...
    <>
      {isAuthenticated ? (
        <Navbar
          ...
          expand="lg"
        >
          <Navbar.Brand className="text-dark h4">Asset Manager</Navbar.Brand>
